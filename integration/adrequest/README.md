...
УНИКУМ использует цифровой код. Описание idflow хранится в служебном обработчике DatareonESB "ИдентификаторыПотоковESB"(#объекты-подсистемы).
...
- **["Исходящий обработчик"](Request.Out.bsl)** - Исходящий обработчик Datareon ESB отвечающий за отправку дозапросов.
